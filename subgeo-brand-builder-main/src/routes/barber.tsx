...
import { Clock, Phone, Scissors, Shield, Sparkles, Zap } from "lucide-react";
...
export const Route = createFileRoute("/barber")({
  head: () => ({
    meta: [
      { title: "Subgeo Barber Shop — Premium cuts in a calm, modern space." },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Subgeo Barber Shop — Subgeo" },
      {
        property: "og:description",
        content: "Premium cuts in a calm, modern space.",
      },
      { property: "og:image", content: barberImg },
    ],
  }),
