      ...
      <div className="relative z-10 mx-auto flex min-h-[82vh] w-full max-w-[1320px] items-center justify-center px-4 pt-16 pb-12 md:pt-[4.5rem] md:pb-[3.5rem]">
        <div className="w-full">
          <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 md:gap-4">
            <span className="justify-self-end font-display text-white font-black leading-[0.85] tracking-[-0.05em] text-[clamp(34px,6.6vw,114px)]">
              subgeo
            </span>
            ...
            <span className="justify-self-start font-display text-white font-black leading-[0.85] tracking-[-0.05em] text-[clamp(34px,6.6vw,114px)]">
              holdings
            </span>
          </div>

          <div className="mt-1 text-center font-display text-white font-black leading-[0.84] tracking-[-0.05em] text-[clamp(28px,5.6vw,86px)]">
            limited
=======
