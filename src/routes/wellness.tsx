...
import { Clock, Phone, Heart, Leaf, Zap, Apple } from "lucide-react";
...
export const Route = createFileRoute("/wellness")({
  head: () => ({
    meta: [
      { title: "Subgeo Wellness — Lifestyle, nutrition and mental wellbeing." },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Subgeo Wellness — Subgeo" },
      {
        property: "og:description",
        content: "Lifestyle, nutrition and mental wellbeing.",
      },
